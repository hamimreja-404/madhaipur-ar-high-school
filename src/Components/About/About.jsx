...
// const timeline = [
//   { year: "1974", event: "Established by the generous donation and vision of Haji Amiruddin, Ramjan Mandal & Radhakishan Ram" },
//   { year: "1984", event: "Received official Government recognition as a Junior High School" },
//   { year: "2006", event: "Upgraded to a High School, expanding curriculum and capacity" },
//   { year: "2012", event: "Became a Higher Secondary School (HS) with new science and arts streams" },
//   { year: "2020s", event: "Integrated digital smart classrooms, skill-based training, and cultural initiatives" },
// ];
...
//           <div className="bg-stone-50 shadow p-6 rounded-xl">
//             <BookOpen className="text-indigo-600 mx-auto" size={36} />
//             <h3 className="text-xl font-semibold text-indigo-800 mt-4 mb-2">Our Mission</h3>
//             <p className="text-gray-700">
//               To empower students with knowledge, values, and skills essential for leading meaningful and successful lives in a rapidly evolving world.
//             </p>
//           </div>
//           <div className="bg-stone-50 shadow p-6 rounded-xl">
//             <Eye className="text-green-600 mx-auto" size={36} />
//             <h3 className="text-xl font-semibold text-green-800 mt-4 mb-2">Our Vision</h3>
//             <p className="text-gray-700">
//               To be a transformative educational institution nurturing leaders of tomorrow through excellence in academics, creativity, and social responsibility.
//             </p>
//           </div>
//           <div className="bg-stone-50 shadow p-6 rounded-xl">
//             <Star className="text-yellow-500 mx-auto" size={36} />
//             <h3 className="text-xl font-semibold text-yellow-700 mt-4 mb-2">Our Core Values</h3>
...
//           <ShieldCheck className="text-indigo-700 mx-auto" size={36} />
//           <h3 className="text-2xl font-semibold text-indigo-800 text-center mt-4 mb-2">Our Motto</h3>
//           <p className="text-center text-gray-700">
//             "Shiksha Hi Shakti Hai" — Education is Power. Our motto reflects our belief that education is the greatest tool for nsformation.
//           </p>
//         </div>
//         <div className="bg-indigo-50 rounded-xl shadow p-6">
//           <GraduationCap className="text-purple-700 mx-auto" size={36} />
//           <h3 className="text-2xl font-semibold text-purple-800 text-center mt-4 mb-2">Academics</h3>
//           <p className="text-center text-gray-700">
//             We offer a strong academic foundation from primary to higher secondary levels, with Science, Arts, and Vocational streams gned to 21st-century skills.
//           </p>
//         </div>
//         <div className="bg-indigo-50 rounded-xl shadow p-6"> 
//           <Shirt className="text-blue-700 mx-auto" size={36} />
//           <h3 className="text-2xl font-semibold text-blue-800 text-center mt-4 mb-2">School Uniform</h3>
//           <img
//             src="src\images\Photo\Uniform.jpg"
//             alt="School Campus"
//             className="rounded-lg my-4 w-full h-56 object-cover"
//           />
//           <p className="text-center text-gray-700">
//             Boys wear sky blue shirts with navy trousers. Girls wear sky blue blouses with navy skirts or salwar suits. Our uniform ters unity and discipline.
//           </p>
//         </div>
//         <div className="bg-indigo-50 rounded-xl shadow p-6">
//           <School className="text-green-700 mx-auto" size={36} />
//           <h3 className="text-2xl font-semibold text-green-800 text-center mt-4 mb-2">Our Campus</h3>
//           <img
//             src="src\images\Photo\Campus.webp"
//             alt="School Campus"
//             className="rounded-lg my-4 w-full h-56 object-cover"
//           />
//           <p className="text-center text-gray-700">
//             Our lush green campus includes modern classrooms, a library, science labs, playgrounds, and an open learning environment for istic development.
//           </p>
//         </div>
//       </section>
...
//           <Award className="mx-auto text-indigo-700" size={40} />
//           <h2 className="text-3xl font-bold text-indigo-800 mt-4 mb-4">
